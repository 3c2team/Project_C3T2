...
<body class="body_gray">
	...
	<script
		...
		crossorigin="anonymous"></script>
	<script src="${pageContext.request.contextPath }/resource/demo/chart-pie-demo2.js"></script>
	<script src="${pageContext.request.contextPath }/resource/demo/chart-area-demo.js"></script>
	<script
