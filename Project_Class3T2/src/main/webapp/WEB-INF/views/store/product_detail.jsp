...
<script src="${pageContext.request.contextPath }/resources/js/order_detail.js"></script>
<body>
	<header>
			...
			<div class="detailTop">
				...
				<div class="detailTopLeft">
					<div class="detailTopMainImg">
						<img src="${pageContext.request.contextPath }/resources/online_img/pasta1.jpg" id="main_img">
					...
					<div class="detailTopMiniImg">
						<ul>
						<!-- 이미지 업로드 수 만큼 조절해야함 -->
							<li><a><img src="${pageContext.request.contextPath }/resources/online_img/pasta2.jpg" id="mini_img" onmouseover="changeImg(this)"></a></li>
							<li><a><img src="${pageContext.request.contextPath }/resources/online_img/pasta3.jpg" id="mini_img" onmouseover="changeImg(this)"></a></li>
							<li><a><img src="${pageContext.request.contextPath }/resources/online_img/pasta4.jpg" id="mini_img" onmouseover="changeImg(this)"></a></li>
							<li><a><img src="${pageContext.request.contextPath }/resources/online_img/pasta5.jpg" id="mini_img" onmouseover="changeImg(this)"></a></li>
							<li><a><img src="${pageContext.request.contextPath }/resources/online_img/pasta5.jpg" onmouseover="changeImgOver()" onmouseout="changeImgOut()"></a></li>
						</ul>					
					</div>
				</div>	<%-- 왼쪽 끝 --%>
